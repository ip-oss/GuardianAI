"""
Quick test of exp9 adversarial robustness experiment with N=2.
...
from exp9_adversarial_robustness import AdversarialRobustnessExperiment
...
def main():
    ...
    experiment = AdversarialRobustnessExperiment(
        ...
        description="Test run with N=2 to validate evasion-aware agents",
